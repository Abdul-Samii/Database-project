...
@media screen and (max-width: 400px) {
  ...
  .img-responsive{width:100px;height:100px;border:2px solid black;border-radius:5px 5px 5px 5px;}
		...
		<script src="addcriminalvalidation.js"></script>
	</head>
		...
		<div class="container-fluid">
				<div class="row">
						...
						{?>
							  ...
							  <a class="active" href="addprisonform.php"><i class="fas fa-plus-square"></i>Add New Prison</a>
						...
						<?php } ?>
								<div class="row">
									<div class="col-med-12">
										<div class="jumbotron">
											<h2 style="background-color:red;color:white;border:10px solid red;border-radius:6px 6px 6px 6px;">ADD NEW Prison</h2>
										</div>
									</div>
								</div>
								...
								<div class="form-box">
									...
									<form method="post" name="formprison" onsubmit="prisonvalidation()" action="">
									<table>
									<tr>
									<th>Prison ID : </th>
									<td><input type="text" name="pid" placeholder="Enter Criminal name" required><td>
									</tr>
									<tr>
									<th>Prison Type :</th><td><input type="text" name="pname"  required><td>
									</tr>
									
									</table>
									
									<input type="submit" name="submitp" value="SAVE">
									...
									<?php
										if(isset($_POST['submitp']))
										{
											...
											$prisonID=$_POST['pid'];
											$prisonname=$_POST['pname'];
											
											$insertcrime=mysqli_query($conn,"insert into prison(prison_ID,prison_type) values('$prisonID','$prisonname')");
											if($insertcrime)
											{
