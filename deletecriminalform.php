		...
		<div class="container-fluid">
				<div class="row">
						...
						{?>
							  ...
							  <a class="active" href="deletecriminalform.php"><i class="fas fa-trash-alt"></i>Delete Criminal Record</a>
				...
				<div class="row">
					...
					<legend>Delete Criminal Record</legend>
						<strong>Enter Criminal ID : </strong>
						<input type="text" name="deleteID" placeholder="Enter Crminal ID">
