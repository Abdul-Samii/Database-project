...
.jumbotron{margin-left:400px;background-color:none;margin-top:150px;}
		...
		<div class="container-fluid">
				<div class="row">
						...
						{?>
							  ...
							  <a class="active" href="uploadmostwanted.php"><i class="fas fa-skull"></i>Most Wanted Criminals Files</a>
				...
				<div class="row">
					...
					<form method="post" action="uploadsaction.php" enctype="multipart/form-data">
    <p>File('.doc','.docx','pdf','jpg','jpeg') : </p>
...
?>
		...
		<form name="formsmall" action="deleteuploadfile.php" method="post">
		<td ><input type="hidden" value="<?php echo $row['file'] ?>" name="formdata"><input type="submit" value="Delete"></td>
		</form>
        </tr>
       <?php
